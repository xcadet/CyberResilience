...
from ChallengeWrapper_react_nodecoys import ChallengeWrapper
...
algo_config = (
    PPOConfig()
    .framework("torch")
    .debugging(logger_config={"logdir":"logs/train_bline_100K_react_nodecoys", "type":"ray.tune.logger.TBXLogger"})
...
model_dir = "models/train_bline_100K_react_nodecoys"
